      ...
      <div style={outerStyle}>
        <div style={cardStyle}>
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '16px', color: 'var(--accent)', marginBottom: '14px' }}>
              Check your email
            </div>
    ...
    <div style={outerStyle}>
      <div style={cardStyle}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '22px', color: 'var(--accent)', letterSpacing: '2px', marginBottom: '8px' }}>
            Reverie
          </div>
